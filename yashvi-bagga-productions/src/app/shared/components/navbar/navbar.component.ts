        ...
        <div class="w-full max-w-lg mx-auto px-5 pt-24 pb-8 md:px-8">
          ...
          <div class="mt-6 pt-5 border-t border-brand-white/10 flex flex-col items-stretch gap-3">
            ...
            <div class="flex justify-center gap-3 mt-4">
              <a href="https://instagram.com/yashvibagga" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#f58529] via-[#dd2a7b] to-[#8134af] text-white shadow-lg transition-transform hover:scale-110">
