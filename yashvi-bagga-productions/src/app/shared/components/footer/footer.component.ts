        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div class="lg:col-span-1">
            ...
            <div class="flex gap-4">
              <a href="https://instagram.com/yashvibagga" target="_blank" rel="noopener" class="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-brand-white/60 hover:border-brand-gold hover:text-brand-gold transition-all duration-300 hover:scale-110">
